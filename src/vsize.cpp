...
/*!
 * \class VSize
 * \brief Определяет размер на двумерной поверхности, используя целые числа.
 *
 ...
 * и ширина должны быть больше 0). isEmpty() возвращает \c true,
 * если оба параметра установлены в 0 или меньше него. 
 ...
 * соответствующими высотой и шириной \a size:
 * \code
 * VSize s(3, 7);
 * VSize r(-1, 4);
 * s += r;
 ...
 * \relates VSizeF
 * Делит высоту и ширину \a size на \a divisor и возвращает результат.
 */
/*!
 * \fn bool operator==(const VSizeF &s1, const VSizeF &s2)
 * \relates VSizeF
