 ...
 * недоступен. В классе хранится пара значений. Одни элемент имеет тип T1,
 ...
 * \endcode
 * Можно обращаться к элементом непосредственно:
 * \code
 * pair.first = "pi";
 ...
 * Две пары считаются не равными, если их первые или вторые элементы
 ...
 * типы данных поддерживали operator<().
 */
/*!
 * \fn bool operator>=(const VPair<T1, T2> &p1, const VPair<T1, T2> &p2)
 * \relates VPair
