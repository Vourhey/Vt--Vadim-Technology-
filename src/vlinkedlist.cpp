 ...
 * Удаляет последний элемент из списка и возвращает его.\т
 ...
 * STL итераторы более низкоуровневые, но более громоздкие для использования.
 ...
 * В общем случае, использовать константный итератор для не константного 
 ...
 * Перемещает итератор на \a j позиции. Для больших значений
 ...
 * \n Результат не определен для VLinkedList::begin()
 * \see operator++()
 */
/*!
 * \fn const_iterator VLinkedList::const_iterator::operator--(int)
 ...
 * \brief Реализует не константный STL итератор для VLinkedList
 *
 * VLinkedList в равной степени поддерживает STL и Java итераторы. STL итераторы
 * более низкоуровневые, но более громоздки в использовании. С другой стороны,
 ...
 * VLinkedList::const_iterator для не константного VLinkedList хорошая практика.
 * Константные итераторы быстрее и делают ваш код безопасней.
 *
 * По умолчанию VLinkedList::iterator создает не инициализированный итератор.
 ...
 * и возвращает итератор на следующий элемент. Вот ещё один путь решения
 * этой же задачи:
 * \code
 * VLinkedList<int>::iterator i = list.begin();
 * while(i != list.end())
 ...
 * }
 * \endcode
 * Это приведет к потери \c i после вызова erase() и, в дальнейшем, к ошибке.
 *
 ...
 * Создает не инициализированный итератор.\n
 * Функции operator*() и operator++() не должны вызываться для не назначенного
