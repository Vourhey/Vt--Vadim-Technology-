 ...
 * значение начальной и конеченой точки. Иначе \c false.
 */
/*!
 ...
 * Устанавливает начальну точку в \a p1 и конечную \a p2.
 * \see setP1(), setP2(), p1() и p2()
 */
/*!
 ...
 * вертикальной состовляющей dx() и dy() соответственно.
 *
 ...
 *
 * Отрезок можно сместить, исползьуя translate().
 * \see VLine
 */
/*!
 * \fn VLineF::VLineF()
...
// можно inline
/*!
 * Возвращает точку на отрезке. Фукнция возвращает начальную
 * точку, если \a t = 0, конечную, есил \a t = 1.
 * \see dx() и dy()
 */
