#ifndef VUNICODETABLES_P_H
#define VUNICODETABLES_P_H
...
namespace VUnicodeTables {
    ...
    VUnicodeTables::LineBreakClass lineBreakClass(uint ucs4);
    inline int lineBreakClass(const VChar &ch)
    { return lineBreakClass(ch.unicode()); }

    int script(uint ucs4);
    inline int script(const VChar &ch)
